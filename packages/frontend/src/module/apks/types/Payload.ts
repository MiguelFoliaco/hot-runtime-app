export interface PayloadBuild {
    ...
    "metrics": {
        "memory": boolean
        "buildEndTimestamp": boolean
        "totalDiskReadBytes": boolean
        "buildStartTimestamp": boolean
        "totalDiskWriteBytes": boolean
        "cpuActiveMilliseconds": boolean
        "buildEnqueuedTimestamp": boolean
        "totalNetworkEgressBytes": boolean
        "totalNetworkIngressBytes": boolean
    },
